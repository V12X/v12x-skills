---
description: Auditoria de segurança em profundidade pelo Método v12x — determinística, verificada, com veredito de publicação.
argument-hint: [alvo ou instrução — ex.: "auditar antes de publicar"]
---

Invoque a skill `v12x-scan` através da ferramenta **Skill** e conduza o processo **completo** dela, sem improvisar uma análise a partir desta frase. A skill é a fonte do método (fases, coletor determinístico, mapa de cobertura, verificação adversarial, veredito).
